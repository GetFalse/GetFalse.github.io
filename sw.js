...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-5354a6","is-html-5354a6","is-jsdelivr-5354a6","is-gtm-5354a6","is-gravatar-5354a6","is-theme-5354a6","is-json-5354a6"];
      return Promise.all(
        names
