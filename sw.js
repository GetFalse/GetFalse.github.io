...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-fd31f8","is-html-fd31f8","is-jsdelivr-fd31f8","is-gtm-fd31f8","is-gravatar-fd31f8","is-theme-fd31f8","is-json-fd31f8"];
      return Promise.all(
        names
