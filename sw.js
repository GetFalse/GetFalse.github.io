...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-bef60b","is-html-bef60b","is-jsdelivr-bef60b","is-gtm-bef60b","is-gravatar-bef60b","is-theme-bef60b","is-json-bef60b"];
      return Promise.all(
        names
