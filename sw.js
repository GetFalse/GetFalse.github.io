...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-5bcaf4","is-html-5bcaf4","is-jsdelivr-5bcaf4","is-gtm-5bcaf4","is-gravatar-5bcaf4","is-theme-5bcaf4","is-json-5bcaf4"];
      return Promise.all(
        names
